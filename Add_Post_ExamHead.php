    ...
    <div class="wrapper_class">
        ...
        if (isset($_POST['submit'])) 
        {
            ...
            else
            {
                ...
                $sql="INSERT INTO placement_post (post_by_id,posted_by,placement_post_data,placement_post_image,placement_post_timedate) VALUES('$faculty_id','$name1','$post_data','$imgfile','$posted_date')";
          ...
          else
          {
              ...
              $sql1="INSERT INTO placement_post (post_by_id,posted_by,placement_post_data,placement_post_timedate) VALUES('$faculty_id','$name1','$post_data','$posted_date')";
                ...
                <div class="dashboard_body_wrapper">
                    <form action="" method="POST" id="myform" name="myform">
                        ...
                        <div class="btn_wrapper">
                            <input type="submit" name="submit" value="POST" class="emp_btn">
                        </div>
                    </form>
