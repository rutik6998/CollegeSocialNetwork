...
<body>
    ...
    <div class="wrapper_class">
        ...
        if (isset($_POST['submit'])) 
        {
            ...
            $sql1="INSERT INTO exam_date (stream,semester,exzam_date) VALUES('$Stream','$Semester','$exam_date')";
            $query=mysqli_query($mysqli,$sql1);
            header('location:Exam_Date.php');
                ...
                <div class="dashboard_body_wrapper">
                    <form action="" method="POST" id="myform" name="myform">
                        ...
                        <div class="form_group">
                            ...
                            <input type="Date" name="exam_date" class="emp_txt" style="height: 18px;">
                        </div>

                        <div class="btn_wrapper">
                            <input type="submit" name="submit" value="Add Exam Date" class="emp_btn2">
                        </div>
                    </form>
