...
<?php
      ...
      if(isset($_POST['del_std']))
      {
        $id=$_POST['del_std'];
        // echo $id; 
        $sql_delete="DELETE from selected_student where select_id='$id'";
...
<body>
    ...
    <div class="wrapper_class">
        ...
        <form method="POST" name="selected_std_form" id="selected_std_form" enctype="multipart/form-data">
            <!-- <input type="hidden" name="edit_dept" id="edit_dept"> -->
            <input type="hidden" name="del_std" id="del_std">
        ...
        <section class="dashboard">
            ...
            <div class="dashboard_header">
                ...
                <h6><a href="Add_Selected_Student.php"> <i class="fa fa-plus"></i> SELECTED STUDENTS</a></h6>
            ...
            <div class="dashboard_body">                        
                ...
                <!-- <div class="table-responsive">-->
                  <table class="table-striped">
                    ...
                    <?php
                    include('configadmin.php');
                    $sql="SELECT * FROM selected_student";
                    ...
                    <tbody>
                      <tr>
                        <td><?php echo $row['select_id'];?></td>
                        <td><?php echo $row['company_name'];?></td>
                        <td><?php echo $row['designation'];?></td>
                        <td><?php echo $row['total_selected'];?></td>
                        <td>
                            <button onclick="delete_std_id(<?php echo $row['select_id'];?>)" class="btn"><i class="fa fa-trash"></i></button>
                        </td>
                      </tr>
                    </tbody>
                  <?php
...
<script type="text/javascript">
    function delete_std_id(id)
    {
        var a = id;
        // alert(a);
        document.getElementById('del_std').value=a;

        document.getElementById("selected_std_form").submit();
    }
</script>