...
<?php
      ...
      if(isset($_POST['del_timetable']))
      {
        $id=$_POST['del_timetable'];
        // echo $id; 
        $sql_delete="DELETE from exam_timetable where exam_id='$id'";
...
<body>
    ...
    <div class="wrapper_class">
        ...
        <form method="POST" name="timetable_form" id="timetable_form" enctype="multipart/form-data">
            <!-- <input type="hidden" name="edit_dept" id="edit_dept"> -->
            <input type="hidden" name="del_timetable" id="del_timetable">
        ...
        <section class="dashboard">
            ...
            <div class="dashboard_header">
                ...
                <h6><a href="Add_Exam_Timetable.php"> <i class="fa fa-plus"></i> ADD EXAM TIMETABLE</a></h6>
                  ...
                  <table class="table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            <button><i class="fa fa-print"></i><a href="images/time_table/<?php echo $row['timetable_file'];?>" target="_blank">Show</a></button>
                        ...
                        <td>
                            <button onclick="delete_timetable(<?php echo $row['exam_id'];?>)" class="btn"><i class="fa fa-trash"></i></button>
...
<script type="text/javascript">
    function delete_timetable(id)
    {
        var a = id;
        // alert(a);
        document.getElementById('del_timetable').value=a;
