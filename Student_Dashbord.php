    ...
    <div class="wrapper_class">
        ...
        if (isset($_POST['submits'])) 
        {
            ...
            else
            {
                ...
                $sql="INSERT INTO placement_post (post_by_id,posted_by,placement_post_data,placement_post_image,placement_post_timedate) VALUES('$student_id','$name1','$post_data','$imgfile','$posted_date')";
          ...
          {
              $sql1="INSERT INTO placement_post (post_by_id,posted_by,placement_post_data,placement_post_timedate) VALUES('$student_id','$name1','$post_data','$posted_date')";
        ...
        <section class="dashboard">
            ...
            <!-- <div class=""> -->
                ...
                <!-- <a href="https://msbte.org.in/#" target="_blank"> <input type="button"  name="" value="MS-BTE" class="srch_emp_btn"></a>
            ...
            <div class="dashboard_body">                        
                ...
                <div class="dashboard_body_wrapper">
                    <form action="" method="POST" id="myform" name="myform">
                        ...
                        <div class="form_group">
                            ...
                            <textarea name="post_data" class="emp_area" required=""></textarea>
                        </div> 
                        ...
                        <div class="btn_wrapper">
                            <input type="submit" name="submits" value="POST" class="emp_btn">
                        </div>
                    </form>
                ...
                <!-- <div class="table-responsive">-->
                  <!-- <table class="table-striped"> -->
                    ...
                    // echo $fact_id=$_SESSION['faculty_id'];
                    ...
                    <div class="leftcolumn">
                      <div class="card">
                        ...
                        <?php if(!empty($row['placement_post_image']))
                        {
                          ?>
                        <div>
                          <img style="height:500px; " style="" src='images/post_images/<?php echo $row['placement_post_image'];?>'>
                        </div>
                      <?php }
                      else 
                      {
